...
public class PatientBookingStep2Activity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverConfirmKey = getIntent().getExtras().getInt(Constants.CONFIRM_KEY);
    ...
    public void onClick(View arg0) {
        if (serverConfirmKey == Integer.parseInt(txtConfirmKey.getText().toString())) {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    try {
                        if ("success".equals(response.getString("status"))) {
                            ...
                            Intent i = new Intent(PatientBookingStep2Activity.this,
